<template>
  <section class="relative text-center">
    ...
    <Icon
      ...
      width="64"
      class="absolute top-[85vh] left-1/2 z-10 text-[#405D72]"
    ...
    <div
      class="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-[#FFF8F3] to-transparent pointer-events-none"
    ></div>
  </section>
</template>
